...
module Net
  class IMAP
    ...
    class SequenceSet
      ...
      #
      # Related: #above, rdoc-ref:SequenceSet@Methods+for+Comparing
      ...
      #
      # Related: #below, rdoc-ref:SequenceSet@Methods+for+Comparing
